...
<div class="form-grop">
    ...
    <input class="form-control" type="text" name="url_clean" id="url_clean" value="{{ old('url_clean', $p->url_clean) }}">
    @error('url_clean')
        <small class="text-danger">{{ $message }}</small>
        <br />
    @enderror
...
<div class="form-group">
    ...
    <textarea class="form-control" id="content" rows="3" name="content" id="content">{{ old('content', $p->content) }}</textarea>
    @error('content')
        <small class="text-danger">{{ $message }}</small>
        <br />
    @enderror
